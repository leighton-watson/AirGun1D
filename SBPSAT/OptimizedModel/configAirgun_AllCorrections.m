function [physConst, t0, icAirgun, icBubble] = configAirgun_AllCorrections(str,airgunPressure,airgunLength,airgunPortArea,airgunDepth, Vinit)
...
switch str
    ...
    case 'Bolt1500LL'
        ...
        V_airgun_const = Vinit * 1.63871e-5;
