function dYdt = Herring(t, Y, params)
% dYdt = Herring(t, Y, params);
...
% file solves the version of the Herring equation given by equation (2) in 
...
dUdt = ((1/rho_infty)*(pb-p_infty+R/c_infty*dpdt*(1-U/c_infty)) - ...
    3/2*(1-4/3*U/c_infty)*U^2) / ((1-2*U/c_infty)*R); % bubble wall velocity
