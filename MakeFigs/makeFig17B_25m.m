...
dataStr = {'280_2500cm_1020psi_598ci_DHA.csv'};
...
beta = [0.8 0.8]; % damping parameter
dissp_boolean = logical([1 0]); % constant or time varying dissipation
Mfac = [1 0.3]; % mass flow reduction factor
Vinit = [600 5000]; % initial bubble volume
